...
const menuItems = ref([
  {
    ...
    label: 'Quản lý dự án',
    routeName: ROUTES_CONSTANTS.MEMBER.children.MYPROJECT.name
  }
])
</script>
            ...
            >
              ...
              <span
                ...
                :class="{
                  ...
                  'text-iconSideBarSelected  group-hover:iconSideBarIsNoSelected':
              ...
              <span
                ...
                :class="{
                  ...
                  'text-textSideBarIsNoSelected font-bold group-hover:textSideBarSelected':
                    route.name !== menuItem.routeName
                }"
              >
                {{ menuItem.label }}
